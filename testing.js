//tealium universal tag - utag.loader ut4.0.202503061446, Copyright 2025 Tealium.com Inc. All Rights Reserved.
...
element.querySelector(".gonow-link").setAttribute("data-tealium-value",toolTile +" || " +tileUrl);
            ...
            if (typeof (salesxApp) != "undefined" && (salesxApp) !== null) {
                if (typeof (salesxApp.loginToken) != "undefined" && (salesxApp.loginToken) !== null) {
                    if (typeof (salesxApp.loginToken.userId) != "undefined" && (salesxApp.loginToken.userId) !== null) {
                        a_customerId = salesxApp.loginToken.userId.toLowerCase();
                    }
                    if (typeof (salesxApp.loginToken.roles) != "undefined" && (salesxApp.loginToken.roles) !== null) {
                        if (typeof (salesxApp.loginToken.roles.length) !== 0) {
                            if (typeof (salesxApp.loginToken.roles[0].cxmRole) != "undefined" && (salesxApp.loginToken.roles[0].cxmRole) !== null) {
            ...
            if (typeof (salesxApp) != "undefined" && (salesxApp) !== null) {
                if (typeof (utag_data) != "undefined" && (utag_data) !== null) {
                    if (typeof (utag_data.id) != "undefined" && (utag_data.id) !== null) {
                        a_customerId = utag_data.id.toLowerCase();
                    }
                }
            }
            if (typeof (salesxApp) != "undefined" && (salesxApp) !== null) {
        ...
        if ((a_currentDomain.indexOf("digitalconnect-itl.basf.com") !== -1) || (a_currentDomain.indexOf("digitalconnect-stage.basf.com") !== -1) || (a_currentDomain.indexOf("digitalconnect.basf.com") !== -1)) {
            if (!a_intervId) {
                a_intervId = setInterval(function() {
    ...
    try {
        try {
            ...
            case 'digitalconnect.basf.com':
                ...
                break;
            case 'digitalconnect-stage.basf.com':
                cctId = 'e97f98da-d4e8-441a-8b92-99600abf511b-test';
                break;
            case 'claims.basf.com':
                cctId = '0192b89f-5bd0-7e26-aa96-e05c2caf9790';
                break;
            }
            if (cctId != "") {
...
if (typeof utag == "undefined" && !utag_condload) {
    ...
    utag.cfg = {
        ...
        path: "//tags.tiqcdn.com/utag/basf/cxm-tools/prod/",
        utid: "basf/cxm-tools/202503061446",
        ignoreSessionStorage: false,
        ignoreLocalStorage: false,
        split_cookie: true
    };
    utag.cfg.v = utag.cfg.template + "202503061446";
    utag.cond = {
        18: 0,
        6: 0
    };
    ...
    utag.loader.GET = function() {
        ...
        utag.handler.extend = [function(a, b) {
            try {
                ...
                if (typeof utag.runonce.ext[252] == 'undefined') {
                    utag.runonce.ext[252] = 1;
                    if (1) {
                        if ((utag.data['cp.b_ui']) !== null && (utag.data['cp.b_ui'] !== "") && (typeof utag.data['cp.b_ui'] !== 'undefined') && (utag.data['dom.domain'].toString().indexOf('basf.com') > -1)) {
                            utag.data["basf_internal_visitor"] = "1";
                        } else {
                            utag.data["basf_internal_visitor"] = "0";
                        }
                    }
                }
            } catch (e) {
        ...
        , function(a, b) {
            try {
                if (1) {
                    try {
                        b['page_domain'] = window.document.domain
                    } catch (e) {}
                }
            } catch (e) {
                utag.DB(e);
